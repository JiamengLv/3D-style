...
parser.add_argument('--model_dir',type=str, default = "./pretrain_model/LDRN_KITTI_ResNext101_pretrained_data_grad.pkl" )
parser.add_argument('--img_dir', type=str, default= None)
parser.add_argument('--img_folder_dir', type=str, default= "../show_image/")
